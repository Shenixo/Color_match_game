...
const HighScore = () => {
  ...
  useEffect(() => {
    // ✅ Save if game theme was playing
    const wasPlaying = IsGameThemePlaying();
    localStorage.setItem("game_theme_was_playing", wasPlaying ? "true" : "false");

    // ✅ Stop game theme sound
    StopGameThemeSound();

    return () => {
      // ✅ Stop celebration sound on leaving
      StopCelebrationSound();
    };
  }, [location.pathname]);
