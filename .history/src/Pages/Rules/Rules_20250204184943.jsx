      ...
      <div className="container">
        ...
        <div data-testid="gameInstructions" className="rules">
          <p>
            ...
            while an incorrect choice results in a -1 point deduction. <span style={{}}>🚀</span>
          </p>
          <p>
            ...
            and make it more engaging 🎵. Additionally, you can navigate back to
            the home page at any time by clicking on the brain icon at the top.
          </p>
          <p> Enjoy the game! 🎮</p>
        </div>
      </div>
