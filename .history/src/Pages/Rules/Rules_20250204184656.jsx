      ...
      <div className="container">
        ...
        <div data-testid="gameInstructions" className="rules">
          <p>
            ...
            while an incorrect choice results in a -1 point deduction.
          </p>
          <p>
            To assist you, a hint feature is available. Clicking on the hint
            button reveals a bulb, which, when clicked, displays the color of
            the chosen card, helping you make a more informed decision. For a
            better experience, enable music to enhance the game&apos;s effect and
            make it more engaging. Additionally, you can navigate back to the
            home page at any time by clicking on the brain icon at the top.
          </p>
            <p> Enjoy the game!</p>
        </div>
      </div>
