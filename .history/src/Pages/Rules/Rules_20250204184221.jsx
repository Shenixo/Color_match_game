      ...
      <div className="container">
        ...
        <div data-testid="gameInstructions" className="rules">
          <p>
            ...
            while an incorrect choice results in a -1 point deduction. To assist
            you, a hint feature is available. Clicking on the hint button
            reveals a bulb, which, when clicked, displays the color of the
            chosen card, helping you make a more informed decision.
            Additionally, you can navigate back to the home page by clicking on
            the brain icon at the top. Enjoy the game!
          </p>
        </div>
      </div>
    </div>
