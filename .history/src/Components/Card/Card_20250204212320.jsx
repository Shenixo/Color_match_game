...
const Card = () => {
  ...
  return (
    <div data-testid="colorOption" className="card">
      {cardArr.map((_, idx) => (
        <button
...
export const listenForIsCorrectUpdates = (callback) => {
  document.addEventListener("isCorrectUpdated", (event) => callback(event.detail))
}
