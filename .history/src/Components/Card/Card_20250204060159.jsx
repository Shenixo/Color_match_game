...
const Card = () => {
  ...
  const [localScore, setLocalScore] = useState(() => {
    return parseInt(localStorage.getItem("score")) || 0; // Load score from localStorage
  });
  ...
  const updateScore = (newScore) => {
    ...
    localStorage.setItem("score", newScore); // Store updated score in localStorage
  };

  const handleWinState = () => {
    updateScore(localScore + 1);
  };
